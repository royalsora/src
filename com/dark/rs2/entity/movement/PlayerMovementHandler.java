package com.dark.rs2.entity.movement;
...
import com.dark.rs2.entity.player.net.out.impl.SendMultiInterface;
...
public class PlayerMovementHandler extends MovementHandler {
	...
	public void process() {
		...
		if ((walkPoint != null) && (walkPoint.getDirection() != -1)) {
			...
			player.getLocation().move(com.dark.rs2.GameConstants.DIR[walkPoint.getDirection()][0], com.dark.rs2.GameConstants.DIR[walkPoint.getDirection()][1]);
		...
		if (player.getRunEnergy().isRunning()) {
			if (player.getRunEnergy().canRun()) {
				...
				if ((runPoint != null) && (runPoint.getDirection() != -1)) {
					...
					player.getMovementHandler().getLastLocation().setAs(player.getLocation());
					player.getLocation().move(com.dark.rs2.GameConstants.DIR[runPoint.getDirection()][0], com.dark.rs2.GameConstants.DIR[runPoint.getDirection()][1]);
