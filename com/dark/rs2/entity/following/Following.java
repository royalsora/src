package com.dark.rs2.entity.following;
...
import com.dark.rs2.entity.pathfinding.RS317PathFinder;
import com.dark.rs2.entity.pathfinding.StraightPathFinder;
...
public abstract class Following {
	...
	public Location getFollowToLocation() {
		...
		int[][] nodes = { { x + com.dark.rs2.GameConstants.DIR[NON_DIAGONAL_DIRECTIONS[0]][0], y + com.dark.rs2.GameConstants.DIR[NON_DIAGONAL_DIRECTIONS[0]][1] }, { x + com.dark.rs2.GameConstants.DIR[NON_DIAGONAL_DIRECTIONS[1]][0], y + com.dark.rs2.GameConstants.DIR[NON_DIAGONAL_DIRECTIONS[1]][1] }, { x + com.dark.rs2.GameConstants.DIR[NON_DIAGONAL_DIRECTIONS[2]][0], y + com.dark.rs2.GameConstants.DIR[NON_DIAGONAL_DIRECTIONS[2]][1] }, { x + com.dark.rs2.GameConstants.DIR[NON_DIAGONAL_DIRECTIONS[3]][0], y + com.dark.rs2.GameConstants.DIR[NON_DIAGONAL_DIRECTIONS[3]][1] } };
