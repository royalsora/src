package com.dark.rs2.entity.item.impl;
...
public class GroundItemHandler {
	...
	public static boolean add(Item item, Location location, Entity entity) 
	{
		if(entity instanceof Player)
		{
			GroundItem groundItem = new GroundItem(item, new Location(location), entity == null ? null : ((Player)entity).getUsername());
			add(groundItem);
			return true;
		}
		return false;
