...
import com.dark.core.task.impl.RegenerateSkillTask;
import com.dark.rs2.content.combat.Combat;
...
public abstract class Entity implements CombatInterface {
	...
	return (x > 2941 && x < 3392 && y > 3521 && y < 3967) || (x > 2941 && x < 3392 && y > 9918 && y < 10366);
	}

	public static boolean inMonkey(int x, int y) {
	return (x > 2690 && x < 2740 && y > 9158 && y < 9211);
	}
	...
	public boolean inSkotizo() {
	return inArea(new Location(1856, 3852, 0), new Location(1875, 3903, 0), false);
	}
	...
	if (inSkotizo() || inGodwars() || inZulrah() || inCorp() || inKraken() || inWGGame()) {
		return true;
	}
	...
	if (WarHandler.CURRENT_WAR != null && inArea(new Location(3200, 2745, WarHandler.CURRENT_WAR.getHeight()), new Location(3267, 2809, WarHandler.CURRENT_WAR.getHeight()), true)) {
		return true;
	}
	return x >= 2333 && y >= 3687 && x <= 2362 && y <= 3717 || x >= 3489 && y >= 9664 && x <= 3519 && y <= 9697 || x >= 3010 && y >= 10110 && x <= 3066 && y <= 10170 || x >= 1865 && y >= 5470 && x <= 1905 && y <= 5490 || x >= 3306 && y >= 9364 && x <= 3332 && y <= 9392 || x >= 3240 && y >= 3250 && x <= 3270 && y <= 3300 || x >= 1856 && y >= 3864 && x <= 1859 && y <= 3895 || ((x >= 2950) && (y >= 4740) && (x <= 3000) && (y <= 4820)) || ((x >= 3462) && (y >= 9476) && (x <= 3510) && (y <= 9524)) || ((x >= 3725) && (y >= 5768) && (x <= 3767) && (y <= 5808)) || ((x >= 2690) && (y >= 9158) && (x <= 2740) && (y <= 9211)) || ((x >= 2956) && (y >= 3714) && (x <= 3006) && (y <= 3750)) || ((x <= 2049) && (y <= 5251) && (x >= 1980) && (y >= 5178)) || ((x >= 2893) && (y >= 4430) && (x <= 2934) && (y <= 4471)) || ((x >= 1761) && (y >= 5337) && (x <= 1780) && (y <= 5370)) || ((x >= 3029) && (x <= 3374) && (y >= 3759) && (y <= 3903)) || ((x >= 2250) && (x <= 2280) && (y >= 4670) && (y <= 4720))
			|| ((x >= 3198) && (x <= 3380) && (y >= 3904) && (y <= 3970)) || ((x >= 3191) && (x <= 3326) && (y >= 3510) && (y <= 3759)) || ((x >= 2987) && (x <= 3006) && (y >= 3912) && (y <= 3930)) || ((x >= 2245) && (x <= 2295) && (y >= 4675) && (y <= 4720)) || ((x >= 3006) && (x <= 3071) && (y >= 3602) && (y <= 3710)) || ((x >= 3134) && (x <= 3192) && (y >= 3519) && (y <= 3646)) || ((z > 0) && (x >= 3460) && (x <= 3545) && (y >= 3150) && (y <= 3267)) || ((x >= 2369) && (x <= 2425) && (y >= 5058) && (y <= 5122)) || ((x >= 3241) && (y >= 9353) && (x <= 3256) && (y <= 9378)) || ((x >= 2914) && (y >= 4359) && (x <= 2972) && (y <= 4412));
	}
	...
	public boolean objectInBuildingArea(int x, int y) {
	if (x >= 3157 && x <= 3182 && y >= 9751 && y <= 9764)
		return true;
	return false;
	...
	if (inArea(new Location(2987, 3930, 0), new Location(3007, 3969, 0), false)) {
