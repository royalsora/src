...
public enum RandomMobChatting {
	...
	MAKEOVER_MAGE(new int[] { 599, 2676 }, 150, "I can change your appearance.", "Welcome to the world of Horizon-OS"),
	COMBAT_TUTOR(new int[] { 705 }, 120, "Welcome to Horizon-OS!", "Become the number one pker of Horizon-OS!")
