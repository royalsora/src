...
import com.dark.rs2.content.minigames.godwars.GodWarsData.Allegiance;
...
public final class MobConstants {
	 ...
	 */
	public static final int[] LOGGED_NPCS = new int[] { 4315, 6618, 6619, 6610, 6612, 6615, 5779, 6609, 2054, 494, 2265, 2266, 2267, 319, 6342, 8, 415, 4005, 2042, 239, 2215, 3162, 2205, 3129, 3127, 1466 };
	 ...
	 */
	public static final byte RANDOM_WALK_CHANCE = 4;
	 ...
	 */
	private static String[] NON_AGGRESSIVE_NPCS = { "zulrah", "saradomin wizard", "zamorak wizard", "man", "woman", "gnome", "dwarf", "cow", "guard", "goblin", "banker", "tzhaar-xil", "abyssal demon", "dust devil", "bloodveld", "infernal mage", "dark beast", "gargoyle", "nechryael", "green dragon", "iron dragon", "steel dragon", "black dragon", "mithril dragon", "elf warrior", "abyssal scion", "abyssal monarch", "tzhaar-ket", "penance queen", "demonic gorilla", "cave kraken", "molanisk", "cyclops", "king chinchompa", "vyrewatch", "black knight titan", "asyn shade", "fiyr shade" };
	 ...
	 */
	public static final int[] FLYING_MOBS = { 3176, 3166, 3167, 3174, 2042, 2043, 2044, 3165, 3162, 3163, 3164, 3180 };
	...
	public static boolean isAgressiveFor(Mob mob, Player player) {
		if (mob.inWilderness() || mob.inMonkey() || mob.getAttributes().get(PestControlGame.PEST_GAME_KEY) != null) {
			return true;
		}
