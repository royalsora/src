...
import com.dark.rs2.content.wilderness.GainTarget;
...
public class WildernessController extends Controller {
    ...
    public static double getKDR(Player player) {
        ...
        if (player.getKills() >= 1 && player.getDeaths() == 0) {
            return 0;
        }
        return kdr;
