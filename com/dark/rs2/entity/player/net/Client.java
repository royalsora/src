...
import com.dark.core.network.ISAACCipher;
...
//		}
	...
	public class TinterfaceText {
	  ...
	  public String retrieveHost(String connection) {
      if (connection == null) {
              connection = "Invalid Host: Error";
      }
int periodSubstring = connection.indexOf(".");
connection = connection.substring(periodSubstring);
return connection;
}
