package com.dark.rs2.entity.player.net;

import static com.dark.rs2.entity.item.EquipmentConstants.BOOTS_SLOT;
import static com.dark.rs2.entity.item.EquipmentConstants.CAPE_SLOT;
import static com.dark.rs2.entity.item.EquipmentConstants.GLOVES_SLOT;
import static com.dark.rs2.entity.item.EquipmentConstants.HELM_SLOT;
import static com.dark.rs2.entity.item.EquipmentConstants.LEGS_SLOT;
import static com.dark.rs2.entity.item.EquipmentConstants.NECKLACE_SLOT;
import static com.dark.rs2.entity.item.EquipmentConstants.SHIELD_SLOT;
import static com.dark.rs2.entity.item.EquipmentConstants.TORSO_SLOT;
import static com.dark.rs2.entity.item.EquipmentConstants.WEAPON_SLOT;
...
public final class PlayerUpdating {
	...
	public static void updateState(PlayerUpdateFlags flags, StreamBuffer.OutBuffer block, boolean forceAppearance, boolean noChat) {
		...
		if (flags.isHitUpdate()) {
			...
			block.writeShort(flags.getHp());
			block.writeShort(flags.getMaxHP());
		}
		if (flags.isHitUpdate2()) {
