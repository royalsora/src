...
import com.dark.core.network.ReceivedPacket;
import com.dark.core.network.StreamBuffer;
import com.dark.rs2.entity.player.Player;
import com.dark.rs2.entity.player.net.Client;
import com.dark.rs2.entity.player.net.in.impl.BankAllButOne;
import com.dark.rs2.entity.player.net.in.impl.BankModifiableX;
import com.dark.rs2.entity.player.net.in.impl.ChangeAppearancePacket;
import com.dark.rs2.entity.player.net.in.impl.ChangeRegionPacket;
import com.dark.rs2.entity.player.net.in.impl.ChatInterfacePacket;
import com.dark.rs2.entity.player.net.in.impl.ClickButtonPacket;
import com.dark.rs2.entity.player.net.in.impl.CloseInterfacePacket;
import com.dark.rs2.entity.player.net.in.impl.CommandPacket;
import com.dark.rs2.entity.player.net.in.impl.FlashingSideIconPacket;
import com.dark.rs2.entity.player.net.in.impl.InputFieldPacket;
import com.dark.rs2.entity.player.net.in.impl.InterfaceAction;
import com.dark.rs2.entity.player.net.in.impl.ItemPackets;
import com.dark.rs2.entity.player.net.in.impl.MovementPacket;
import com.dark.rs2.entity.player.net.in.impl.NPCPacket;
import com.dark.rs2.entity.player.net.in.impl.ObjectPacket;
import com.dark.rs2.entity.player.net.in.impl.PlayerOptionPacket;
import com.dark.rs2.entity.player.net.in.impl.PrivateMessagingPacket;
...
public class PacketHandler {
	...
	private static final IncomingPacket[] packets = new IncomingPacket[500];
