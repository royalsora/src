package com.dark.rs2.content.shopping;
...
import com.dark.rs2.content.shopping.Shopping.ShopType;
import com.dark.rs2.content.shopping.impl.AchievementShop;
import com.dark.rs2.content.shopping.impl.AgilityShop;
import com.dark.rs2.content.shopping.impl.AbyssalShop;
import com.dark.rs2.content.shopping.impl.BountyShop;
import com.dark.rs2.content.shopping.impl.CreditsShop;
import com.dark.rs2.content.shopping.impl.CreditsShop2;
import com.dark.rs2.content.shopping.impl.CreditsShop3;
import com.dark.rs2.content.shopping.impl.GracefulShop;
import com.dark.rs2.content.shopping.impl.TriviaShop;
import com.dark.rs2.content.shopping.impl.PestShop;
import com.dark.rs2.content.shopping.impl.PrestigeShop;
import com.dark.rs2.content.shopping.impl.SkillcapeShop;
import com.dark.rs2.content.shopping.impl.SlayerShop;
import com.dark.rs2.content.shopping.impl.TokkulShop;
import com.dark.rs2.content.shopping.impl.VotingShop;
import com.dark.rs2.content.skill.summoning.Pouch;
...
public class Shop extends ItemContainer {
	...
	public static void declare() {
		...
		shops[AbyssalShop.SHOP_ID] = new AbyssalShop();
	...
	public void buy(Player player, int slot, int id, int amount) {
		...
		if (System.currentTimeMillis() - player.shopDelay < 500) {
	...
	public boolean sell(Player player, int id, int amount) {
		...
		if (GameDefinitionLoader.getItemDef(id).getGeneralPrice() > 25_000_001) {
			player.getClient().queueOutgoingPacket(new SendMessage("[" + ShopConstants.COLOUR + "*</col>] You cannot sell items worth more than 25,000,000 coins!"));
			return false;
		}
