	...
	public boolean clickButton(int button) {
		...
		case DialogueConstants.OPTIONS_3_2:
			if (player.getCredits() < 10) {
				DialogueManager.sendStatement(player, "You do not have enough Gold points to do this!");
				return false;
			}
		...
		case DialogueConstants.OPTIONS_5_2:
			DialogueManager.sendOption(player, "Edit shop", "Edit shop motto (10 Gold points)", "Edit shop color (10 Gold points)");
			return true;
