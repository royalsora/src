...
public class FiremakingDialogue extends Dialogue {
	...
	public void execute() {
		...
		case 0:
			...
			break;
		case 1:
			DialogueManager.sendOption(player, "Benifits of changing fire color", "Change fire color (10 Gold points)", "Nothing");
			break;
		case 2:
			DialogueManager.sendNpcChat(player, 118, Emotion.HAPPY_TALK, "By paying 10 Gold points you can change all fire colors.", "You will earn double cooking & firemaking exp for 30mins.");
			break;
