...
public class RingOfSlayingDialogue extends Dialogue {
	...
	public boolean clickButton(int id) {
		...
		case DialogueConstants.OPTIONS_4_4:
			DialogueManager.sendStatement(player, "Your current task is to kill:", player.getSlayer().getAmount() + " " + player.getSlayer().getTask());
			break;
	...
	public void execute() {
		...
		case 0:
			...
			break;
		case 1:
			DialogueManager.sendOption(player, "Obtain task", "Set co-op slayer partner", "Reset my task", "What is my current task?");
			break;
		case 2:
