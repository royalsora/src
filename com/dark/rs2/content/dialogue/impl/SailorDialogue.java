...
public class SailorDialogue extends Dialogue {
	...
	public void execute() {
		switch (next) {
		case 0: 
			DialogueManager.sendNpcChat(player, 3936, Emotion.HAPPY_TALK, "Hello adventurer!", "Are you interested in traveling the lands of Horizon-OS?", "I can take you places, for " + COST + " coins!");
			next++;
			break;
		case 1:
