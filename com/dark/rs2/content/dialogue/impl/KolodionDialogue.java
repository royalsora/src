...
public class KolodionDialogue extends Dialogue {
	...
	public void execute() {
		...
		case 2:
			DialogueManager.sendNpcChat(player, 1603, Emotion.DEFAULT, "There are these wizards infesting my trivia.", "I need them gone by any means.", "Basically just kill them.", "Destroy their crappy existance!");
			next ++;
			break;
		...
		case 4:
			DialogueManager.sendNpcChat(player, 1603, Emotion.DEFAULT, "Click the lever, go outside until you see a cave entrance.", "Click the lever and go in the middle of the trivia.", "You can't miss it.");
			next ++;
			break;
