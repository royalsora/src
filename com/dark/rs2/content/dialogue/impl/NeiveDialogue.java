...
public class NeiveDialogue extends Dialogue {
	...
	public void execute() {
		...
		case 0:
			DialogueManager.sendNpcChat(player, 490, Emotion.DEFAULT, "Hello my elite friend.", "I can give you a boss task.", "Are you interested?");
			next ++;
			break;
			
		case 1:
			DialogueManager.sendOption(player, "Yes", "No", "Reset current task (@dre@100k</col>)");
			break;
