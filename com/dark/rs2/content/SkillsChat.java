...
public class SkillsChat {
	...
	public static String[] skillName = { 
		...
		"Herblore", "Agility", "Thieving", "Slayer", "Farming", "Runecrafting","Summoing", "Hunter"
	};
	...
	public static boolean handle(Player player, int buttonId) {
		...
		if (chat.getButton() == 94166) {
			player.getUpdateFlags().sendForceMessage("[QC] My task is to kill "+player.getTasks()+"");
		}
