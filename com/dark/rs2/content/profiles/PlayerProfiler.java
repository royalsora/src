package com.dark.rs2.content.profiles;
...
import com.dark.rs2.entity.player.net.out.impl.SendPlayerProfilerIndex;
...
public class PlayerProfiler {
	...
	public static void displayProfile(Player player, Player viewing, boolean inRegion) {
		...
		String[] STRINGS = { 
			...
			"</col>Gold Points: @whi@" + viewing.getCredits(),		
			...
			"</col>Trivia Points: @whi@" + viewing.getTriviaPoints(),
	...
	public static void myProfile(Player player) {
		...
		String[] STRINGS = { 
			...
			"</col>Gold Points: @whi@" + player.getCredits(),		
			...
			"</col>Trivia Points: @whi@" + player.getTriviaPoints(),
