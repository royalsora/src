...
public class CrystalChest {
	...
	public static final Item[] UNCOMMON_CHEST_REWARDS = { new Item(ItemNames.SHIELD_LEFT_HALF), new Item(ItemNames.SHIELD_RIGHT_HALF), new Item(ItemNames.CASH_CASKET), new Item(ItemNames.TEACHER_WAND), new Item(ItemNames.CLUE_SCROLL__MEDIUM_1), new Item(ItemNames.DRAGONSTONE_AMMY_2), new Item(ItemNames.MYSTERIOUS_EMBLEM_2), new Item(ItemNames.GRANITE_SHIELD), new Item(ItemNames.GLOVES_13), new Item(ItemNames.RUNE_CLAWS), new Item(ItemNames.HELM_OF_NEITIZNOT), new Item(ItemNames.WARRIOR_HELM), new Item(ItemNames.ARCHER_HELM), new Item(ItemNames.FARSEER_HELM), new Item(ItemNames.SLAYER_BELL), new Item(ItemNames.DOCTORS_GOWN), };

	public static final Item[] RARE_CHEST_REWARDS = { new Item(ItemNames.MASTER_WAND), new Item(ItemNames.INFINITY_TOP), new Item(ItemNames.INFINITY_HAT), new Item(ItemNames.INFINITY_BOOTS), new Item(ItemNames.INFINITY_GLOVES), new Item(ItemNames.MAGES_BOOK), new Item(ItemNames.CLUE_SCROLL__HARD), new Item(ItemNames.MYSTERIOUS_EMBLEM_3), new Item(ItemNames.MYSTERY_BOX), new Item(ItemNames.ECUMENICAL_KEY), new Item(ItemNames.GOLDEN_KEY), new Item(ItemNames.WOLF_WHISTLE), new Item(ItemNames.UNCUT_ONYX), new Item(ItemNames.INFINITY_BOTTOMS) };
