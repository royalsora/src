package com.dark.rs2.content.cluescroll;
...
import com.dark.rs2.content.Emotes.Emote;
import com.dark.rs2.content.cluescroll.Clue.ClueType;
import com.dark.rs2.content.cluescroll.scroll.EmoteScroll;
import com.dark.rs2.content.cluescroll.scroll.MapScroll;
import com.dark.rs2.entity.Location;
import com.dark.rs2.entity.World;
import com.dark.rs2.entity.item.Item;
import com.dark.rs2.entity.item.ItemContainer;
import com.dark.rs2.entity.item.ItemContainer.ContainerTypes;
...
public enum ClueScrollManager {
    ...
    public static void declare() {
        ...
        EASY.add(1, new Item(19689, 1)); // Clue Hunter Garb
        EASY.add(1, new Item(19691, 1)); // Clue Hunter Gloves
        EASY.add(1, new Item(19693, 1)); // Clue Hunter Trousers
        EASY.add(1, new Item(19695, 1)); // Clue Hunter Boots
        EASY.add(1, new Item(19697, 1)); // Clue Hunter Cloak
        ...
        MEDIUM.add(5, new Item(19689, 1)); // Clue Hunter Garb
        MEDIUM.add(5, new Item(19691, 1)); // Clue Hunter Gloves
        MEDIUM.add(5, new Item(19693, 1)); // Clue Hunter Trousers
        MEDIUM.add(5, new Item(19695, 1)); // Clue Hunter Boots
        MEDIUM.add(5, new Item(19697, 1)); // Clue Hunter Cloak
        ...
        HARD.add(10, new Item(12526, 1)); // Fury ornament kit
        ...
        HARD.add(10, new Item(12389, 1)); // Gilded scimitar
        HARD.add(10, new Item(12391, 1)); // Gilded boots
        ...
        HARD.add(2, new Item(10346, 1)); // 3rd age platelegs
        HARD.add(2, new Item(10348, 1)); // 3rd age platebody
        HARD.add(2, new Item(10350, 1)); // 3rd age full helmet
        HARD.add(2, new Item(10352, 1)); // 3rd age kiteshield
        HARD.add(2, new Item(10330, 1)); // 3rd age range top
        HARD.add(2, new Item(10332, 1)); // 3rd age range legs
        HARD.add(2, new Item(10334, 1)); // 3rd age range coif
        HARD.add(2, new Item(10336, 1)); // 3rd age vambraces
        HARD.add(2, new Item(10338, 1)); // 3rd age robe top
        HARD.add(2, new Item(10340, 1)); // 3rd age robe
        HARD.add(2, new Item(10342, 1)); // 3rd age mage hat
        HARD.add(2, new Item(10344, 1)); // 3rd age amulet
        HARD.add(1, new Item(12422, 1)); // 3rd age wand
        HARD.add(1, new Item(12424, 1)); // 3rd age bow
        HARD.add(1, new Item(12426, 1)); // 3rd age longsword
        HARD.add(1, new Item(12437, 1)); // 3rd age cloak
        ...
        HARD.add(20, new Item(12496, 1)); // Ancient coif
        HARD.add(20, new Item(12494, 1)); // Ancient chaps
        HARD.add(20, new Item(12492, 1)); // Ancient d'hide
        HARD.add(20, new Item(12490, 1)); // Ancient bracers
        ...
        MEDIUM.add(10, new Item(19689, 1)); // Clue Hunter Garb
        MEDIUM.add(10, new Item(19691, 1)); // Clue Hunter Gloves
        MEDIUM.add(10, new Item(19693, 1)); // Clue Hunter Trousers
        MEDIUM.add(10, new Item(19695, 1)); // Clue Hunter Boots
        MEDIUM.add(10, new Item(19697, 1)); // Clue Hunter Cloak
     ...
     *
     * @param player - The player to generate the clue scroll for.
     * @param difficulty - The difficulty of the clue scroll to generate.
    ...
    public static void reward(Player player, int item, ClueDifficulty difficulty) {
        ...
        for (int i = 0; i < items.items.length; i++) {
            ...
            if (items.items[i].getDefinition().getGeneralPrice() >= 500_000 || items.items[i].getDefinition().getName().contains("fury") || items.items[i].getDefinition().getName().contains("Gilded") || items.items[i].getDefinition().getName().contains("Ranger") || items.items[i].getDefinition().getName().contains("Hunter") || items.items[i].getDefinition().getName().contains("Robin") || items.items[i].getDefinition().getName().contains("3rd")) {
     ...
     *
     * @param player - The player opening the scroll.
        ...
        if (scroll == null) {
            switch (item) {
                case CASKET_EASY:
                    ...
                    player.easyClues += 1;
                    player.send(new SendMessage("<col=cc0000>You have completed @blu@" + player.easyClues + " <col=cc0000> Easy clue scrolls, well done!"));
                    return true;
                case CASKET_MEDIUM:
                    reward(player, item, ClueDifficulty.MEDIUM);
                    player.mediumClues += 1;
                    player.send(new SendMessage("<col=cc0000>You have completed @blu@" + player.mediumClues + " <col=cc0000> Medium clue scrolls, well done!"));
                    return true;
                case CASKET_HARD:
                    reward(player, item, ClueDifficulty.HARD);
                    player.hardClues += 1;
                    player.send(new SendMessage("<col=cc0000>You have completed @blu@" + player.hardClues + " <col=cc0000> Hard clue scrolls, well done!"));
                    return true;
            }
            return false;
        }
