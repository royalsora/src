package com.dark.rs2.content.minigames.duelarena;
...
public class DuelingController extends Controller {
	...
	public Location getRespawnLocation(Player player) {
		Location p = DuelingConstants.RESPAWN_LOCATIONS[com.dark.core.util.Utility.randomNumber(DuelingConstants.RESPAWN_LOCATIONS.length)];
		int[] dir = com.dark.rs2.GameConstants.DIR[com.dark.core.util.Utility.randomNumber(com.dark.rs2.GameConstants.DIR.length)];
