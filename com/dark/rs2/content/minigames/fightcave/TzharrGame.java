package com.dark.rs2.content.minigames.fightcave;
...
import com.dark.rs2.content.minigames.fightcave.TzharrData.NPCS_DETAILS;
...
public final class TzharrGame {
	...
	public static void finish(Player player, boolean reward) {
		if (reward) {
			...
			AchievementHandler.activateAchievement(player, AchievementList.OBTAIN_25_FIRECAPES, 1);
