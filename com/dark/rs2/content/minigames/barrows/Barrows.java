package com.dark.rs2.content.minigames.barrows;
...
import com.dark.rs2.entity.player.net.out.impl.SendPlayerHint;
...
public class Barrows {
	...
	private static final Item[] RARE_ITEM = { new Item(4708), new Item(4710), new Item(4712), new Item(4714), new Item(4716), new Item(4718), new Item(4720), new Item(4722), new Item(4724), new Item(4726), new Item(4728), new Item(4730), new Item(4732), new Item(4734), new Item(4736), new Item(4738), new Item(4745), new Item(4749), new Item(4751), new Item(4753), new Item(4755), new Item(4757), new Item(4759), new Item(2944, 1) };
	...
	public static boolean clickObject(Player player, int id, int x, int y, int z) {
		...
		case 20723:
			if (player.getBarrowsKC() == 6) {
				...
				AchievementHandler.activateAchievement(player, AchievementList.LOOT_1_BARROWS_CHESTS, 1);
				AchievementHandler.activateAchievement(player, AchievementList.LOOT_25_BARROWS_CHESTS, 1);
