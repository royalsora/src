package com.dark.rs2.content.minigames.godwars;
...
public class GodWarsData {
	...
	private static final int[] ARMADYL_ITEMS = new int[] { 13124, 12512, 12510, 12508, 12506, 12478, 12476, 12474, 12472, 12470, 12263, 12261, 12259, 12257, 12255, 12253, 11830, 11828, 11826, 11802, 11785, 87, 84 };
	private static final int[] BANDOS_ITEMS = new int[] { 13124, 11804, 11832, 11834, 11836, 12265, 12267, 12269, 12271, 12273, 12275, 12480, 12482, 12484, 12486, 12488, 12502, 12500, 12498, 12504, 11061 };
	private static final int[] SARADOMIN_ITEMS = new int[] { 13124, 12809, 11838, 11806, 10470, 10464, 10458, 10452, 10446, 10440, 10390, 10388, 10386, 10384, 6762, 3479, 2667, 2665, 2663, 2661, 2415, 2412, 3840 };
	private static final int[] ZAMORAK_ITEMS = new int[] { 13124, 1033, 1035, 2414, 2417, 2653, 2655, 2657, 2659, 3478, 10368, 10370, 10372, 10374, 6764, 10444, 10450, 10456, 10460, 10468, 10474, 11808, 11824, 11889, 12638, 3842 };
	...
	public enum GodWarsNpc {
		...
		AVIANSIE_89(3180, Allegiance.ARMADYL),
		...
		TSANON_KARLAK(3130, Allegiance.ZAMORAK),
