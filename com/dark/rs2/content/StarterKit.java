...
public class StarterKit {
	...
	public enum StarterData {
		NORMAL(202051, 51766, 0, new Item[] { new Item(995, 300000), new Item(1323, 1), new Item(1333, 1), new Item(4587, 1), new Item(841, 1), new Item(861, 1), new Item(884, 250), new Item(892, 100), new Item(1381, 1), new Item(554, 300), new Item(558, 100), new Item(562, 100), new Item(542, 1), new Item(544, 1), new Item(3105, 1), new Item(1712, 1), new Item(7947, 100), new Item(12696, 10), new Item(13024, 1), new Item(7460, 1) }, "Play Horizon-OS as a regular player.", "Players have access to everything available.", "No additional restrictions will be applied to your account"),
