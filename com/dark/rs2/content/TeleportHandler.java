...
public class TeleportHandler {
	...
	public enum TeleportationData {
		SEERS_VILLAGE(238123, 0, "None", "None", 0, new Location(2725, 3485, 0), false, false),
		CATHERBY(238124, 0, "None", "None", 0, new Location(2833, 3438, 0), false, false),
		FALADOR_MINE(238125, 0, "None", "None", 0, new Location(3044, 9783, 0), false, false),
		GNOME_STRONGhOLD(238126, 0, "None", "None", 0, new Location(2480, 3437, 0), false, false),
		FELDIP_HILLS(238127, 0, "None", "None", 0, new Location( 2607, 2896, 0), false, false),
		FOURTY_OBELISK(238127, 0, "None", "None", 0, new Location( 2985, 3863, 0), false, false),
		WEST_DRAGONS(238127, 0, "None", "None", 0, new Location( 2976, 3629, 0), false, false),
		FALADOR(238127, 0, "None", "None", 0, new Location( 2965, 3380, 0), false, false),
		ARDOUGNE(238127, 0, "None", "None", 0, new Location( 2661, 3305, 0), false, false),
		YANILLE(238127, 0, "None", "None", 0, new Location(2600, 3098, 0), false, false),
		CANFIS(238127, 0, "None", "None", 0, new Location(3495, 3487, 0), false, false),
		
		CERBERUS(250059, 1500, "High combat", "", 230, new Location(1240, 1226, 0), false, false),
		GORILLA(250059, 1500, "High combat", "", 230, new Location(2716, 9183, 0), false, false),
		...
		SKELETAL_WYVERNS(238132, 3000, "None", "None", 0, new Location(3056, 9555, 0), false, false),

		/** Skilling */
		WILD_RESOURCE(242099, 3000, "54 Wild!", "None", 0, new Location(3184, 3947, 0), false, false),
		THIEVING(242100, 3000, "None", "None", 0, new Location(2661, 3308, 0), false, false),
		...
		HUNTER(242104, 2000, "None", "None", 0, new Location(3741, 3004, 0), false, false),
		FISHING(242105, 4000, "None", "None", 0, new Location(2840, 3437, 0), false, false),
		WOODCUTTING(242106, 3000, "None", "None", 0, new Location(1587, 3488, 0), false, false),
		...
		VARROCK(246076, 0, "None", "None", 0, new Location(3212, 3425, 0), false, false),
		...
		CALLISTO(250061, 5750, "High combat", "40+ Wild", 470, new Location(3283, 3853, 0), true, true),
		...
		FREMENNIK(250066, 4500, "High combat", "20+ Wild", 204, new Location( 2803, 9999, 0), false, false),
		KALPHITE_QUEEN(250066, 4500, "High combat", "20+ Wild", 204, new Location( 3494, 9486, 0), false, false),
		SKOTIZO(250066, 4500, "High combat", "20+ Wild", 331, new Location( 1860, 3868, 0), false, false),
		/** Minigames */
		...
		ABYSSAL_NEXUS(254031, 0, "None", "None", 0, new Location(2970, 4782, 0), false, false),
		WEAPON_GAME(254032, 0, "None", "None", 0, WeaponGameConstants.LOBBY_COODINATES, false, false),
		BARB_ASSAULT(254031, 0, "None", "None", 0, new Location(1886, 5455, 0), false, false),
	...
	public static boolean specialCase(Player player, int buttonId) {
		...
		case 250060://Lizard
			TaskQueue.queue(new Task(5) {
				@Override
				public void execute() {
				//	LIZARD mob = new LIZARD(player, new Location(2266, 3073, player.getIndex() << 2));
				//	mob.face(player);
				//	mob.getUpdateFlags().sendAnimation(new Animation(5071));
					//player.face(mob);
					player.send(new SendMessage("Welcome to Lizard Shamen."));
					DialogueManager.sendStatement(player, "Welcome to Lizard Shamen.");
					stop();
				}
