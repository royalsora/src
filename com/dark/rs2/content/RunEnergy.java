...
import com.dark.rs2.entity.player.net.out.impl.SendUpdateEnergy;
...
public class RunEnergy {
	...
	public void onRun() {
		...
		if ((player.getEquipment().contains(11850)) && (player.getEquipment().contains(11852) && (player.getEquipment().contains(11854) && (player.getEquipment().contains(11856) && (player.getEquipment().contains(11858) && (player.getEquipment().contains(11860) &&
		((player.getMaxLevels()[16] == 69) && (!player.getController().equals(ControllerManager.WILDERNESS_CONTROLLER))))))))) {
			return;
		}
