...
import com.dark.rs2.content.combat.impl.DamageMap;
import com.dark.rs2.content.combat.impl.Magic;
import com.dark.rs2.content.combat.impl.Melee;
	...
	public boolean withinDistanceForAttack(CombatTypes type, boolean noMovement) {
		...
		if (entity.isNpc()) {
			...
			if (m != null) {
				...
				} else if (m.getId() == 2042 || m.getId() == 2043 || m.getId() == 1466 || m.getId() == 2044) {
					dist = 25;
					ignoreClipping = true;
				}
