...
public class BandosGodswordEffect implements CombatEffect {
	...
	public void execute(Player p, Entity e) {
		...
		if (!e.isNpc()) {
			p2 = com.dark.rs2.entity.World.getPlayers()[e.getIndex()];
		}
		...
		if (e.getLevels()[BGS_DRAIN_IDS[id]] - drain < 0) {
			...
			p.getClient().queueOutgoingPacket(new SendMessage("You drain your opponents " + com.dark.rs2.content.skill.Skills.SKILL_NAMES[BGS_DRAIN_IDS[id]] + " down to 0."));
			...
			if (id < BGS_DRAIN_IDS.length - 1) {
				...
				p.getClient().queueOutgoingPacket(new SendMessage("You drain some of your opponents " + com.dark.rs2.content.skill.Skills.SKILL_NAMES[BGS_DRAIN_IDS[id]] + "."));
			}
		} else {
