package com.dark.rs2.content.pets;
...
public class BossPets {
	...
	public enum PetData {
		...
		PRINCE_CHIN(13324, 6719),
		BLACK_CHIN(13325, 6720),
		GOLD_CHIN(13326, 6721),
		JAD_PET(13225, 5892),
		ROCK_GOLEM(13321, 6716),
		MONKEY(8942, 5268),
		WOLF_PUP(10896, 107),
		GERMAN_SHEPARD(8132, 111),
		DEREK_SWAN(10898, 1832),
		BABY_COW(2522, 5842),
		OGRE(2377, 2096),
		ABYSSAL_DEMON(4149, 416),
		Frog_Pet(11023, 478),
		Bouncer(10591, 3509),
		PENANCE(12703, 6642);
	...
	public static boolean spawnPet(Player player, int itemID, boolean loot) {
		...
		if (loot) {
			...
			player.send(new SendMessage("You release your " + mob.getDefinition().getName() + "."));
		}
		return true;
	}
