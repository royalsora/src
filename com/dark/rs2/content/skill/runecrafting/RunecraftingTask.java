package com.dark.rs2.content.skill.runecrafting;
...
public class RunecraftingTask extends Task {
	...
	public void execute() {
		...
		if (data == RunecraftingData.NATURE) {
			AchievementHandler.activateAchievement(player, AchievementList.CRAFT_1000_NATURE_RUNES, amount);
		}
