...
import com.dark.rs2.entity.player.net.out.impl.SendInterfaceConfig;
import com.dark.rs2.entity.player.net.out.impl.SendMessage;
import com.dark.rs2.entity.player.net.out.impl.SendSkill;
...
public class Skill {
     ...
     *
     * @param player The player creating the skill instance
     */
     ...
     *
     * @param type The type of combat the player dealt damage with
     ...
     *
     * @param id The id of the skill to add experience too
     * @param experience The amount of experience too add
     * @return
     */
    public double addExperience(int id, double experience) {
        ...
        experience = (player.isHardMode() ? Skills.EXPERIENCE_RATES[id] * (experience * .20) : (experience * Skills.EXPERIENCE_RATES[id])) * 1.0D;
        ...
        if (player.getMaxLevels()[id] < newLevel) {
            ...
            if (id == DUNGEONEERING ? newLevel == 120 : newLevel == 99) {
                World.sendGlobalMessage("<col=3124814><img=8> " + player.getUsername() + " has just achieved level " + 99 + " in " + Skills.SKILL_NAMES[id] + "! :" + player.getSkillPrestiges()[id]);
            }
        }
     ...
     * @param amount The amount to remove from the skill
     */
     ...
     *
     * @param id The skill to check the level for
     * @param experience The amount of experience to check for a level
     ...
     * @param level The level the player is getting the experience for
     ...
     *
     * @param delay The delay to lock the skills
     */
     ...
     *
     * @param lvl The level the player has just achieved
     * @param skill The skill the player achieved the level in
     */
     ...
     *
     * @param id The id of the skill to reset
     */
     ...
     *
     * @param locked If he experience is locked or unlocked
     */
     ...
     *
     * @param id The id of the skill
     * @param level The level to set the skill too
     */
     ...
     *
     * @param id The id of the skill being updated
     */
    public void update(int orgId) {
        int id = orgId;
        if (id == 21 || id == 23 || id == 24) {//sends hunter stats instead of disabled ones
            id = 22;
        }
        player.send(new SendSkill(orgId, getLevels()[id], (int) experience[id]));
