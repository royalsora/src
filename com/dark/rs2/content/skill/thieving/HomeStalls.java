...
public class HomeStalls extends Task {
	...
	public static void successfull(Player player, stallData stall) {
			...
			AchievementHandler.activateAchievement(player, AchievementList.THIEVE_100_TIMES_FROM_STALLS, 1);
			handleRandom(player);
	}
	...
	public final static String FORCED_CHAT[] = { "Ow!", "Ouch!", "What the-?", "This hurts!", "Noooo!", "I want to live!", "Somebody help me!", "Only on Horizon-OS -.-", };
