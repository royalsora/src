package com.dark.rs2.content.skill.smithing;
...
public class SmithingConstants {
	...
	public static void sendSmeltSelectionInterface(Player p) {
		Item[] bars = new Item[] { new Item(2349), new Item(2351), new Item(2355), new Item(2353), new Item(2357), new Item(2359), new Item(2361), new Item(2363), new Item(13356) };
		for (int i = 0; i < 8; i++) {
			p.getClient().queueOutgoingPacket(new SendItemOnInterface(2405 + i + (i > 2 ? 1 : 0), 140, bars[i].getId()));
		}
