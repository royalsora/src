...
public enum SmeltingData {
	...
	MITHRIL_BAR(new Item[] { new Item(447), new Item(453, 1) }, new Item(2359), 50, 30.0D),
	ADAMANITE_BAR(new Item[] { new Item(449), new Item(453, 1) }, new Item(2361), 70, 37.5D),
	LOVAKITE_BAR(new Item[] { new Item(13356), new Item(453, 2) }, new Item(13354), 45, 17.5D),
