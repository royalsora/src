...
public class FireColor {
	...
	public static String FIRE_STARTER = "None", FIRE_STARTER_CLAN = "fires";
	...
	public static final void open(Player player) {
		...
		player.send(new SendString("goten's Clan: " + fires.getColor()[1] + "" + FIRE_STARTER_CLAN, 49760));
	...
	public static final boolean can(Player player) {
		...
		if (player.getCredits() < 10) {
			DialogueManager.sendStatement(player, "You need 10 Gold points to do this!");
			return false;
		}
		return true;
	}
