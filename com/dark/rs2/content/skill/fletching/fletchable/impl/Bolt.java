package com.dark.rs2.content.skill.fletching.fletchable.impl;

import com.dark.rs2.content.skill.fletching.Fletching;
import com.dark.rs2.content.skill.fletching.fletchable.Fletchable;
import com.dark.rs2.content.skill.fletching.fletchable.FletchableItem;
import com.dark.rs2.entity.item.Item;

public enum Bolt implements Fletchable {
	//TEST(new Item(1857, 1), new Item(12934, 50000), new FletchableItem(new Item(749, 1), 1, 1.6)),
	...
	RUBY_BOLT(new Item(9143, 10), new Item(9191, 10), new FletchableItem(new Item(9242, 10), 63, 6.3)),
	DIAMOND_BOLT(new Item(9143, 10), new Item(9192, 10), new FletchableItem(new Item(9340, 10), 65, 7.0)),
	DRAGONSTONE_BOLT(new Item(9144, 10), new Item(9193, 10), new FletchableItem(new Item(9244, 10), 71, 8.2)),
