...
public class WoodcuttingTask extends Task {
    ...
    private void animate() {
        PlayerSounds.sendRegionSound(player, player.getLocation(), 472, 0, 0);
    ...
    private void successfulAttempt() {
        PlayerSounds.sendRegionSound(player, player.getLocation(), 1312, 0, 0);
        ...
        if (rsObject != null) {
            ...
            ObjectManager.getInstance().register(replacement);
