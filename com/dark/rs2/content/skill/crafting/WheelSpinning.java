package com.dark.rs2.content.skill.crafting;

import com.dark.core.task.Task;
import com.dark.core.task.impl.ProductionTask;
...
public class WheelSpinning extends ProductionTask {
	...
	public String getInsufficentLevelMessage() {
		return "You need a " + com.dark.rs2.content.skill.Skills.SKILL_NAMES[getSkill()] + " level of " + getRequiredLevel() + " to spin " + GameDefinitionLoader.getItemDef(spinnable.getOutcome().getId()).getName().toLowerCase() + ".";
	}
