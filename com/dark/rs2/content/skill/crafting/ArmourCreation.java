...
public class ArmourCreation extends ProductionTask {
	...
	public String getInsufficentLevelMessage() {
		return "You need a " + com.dark.rs2.content.skill.Skills.SKILL_NAMES[getSkill()] + " level of " + getRequiredLevel() + " to create " + GameDefinitionLoader.getItemDef(getRewards()[0].getId()).getName() + ".";
	}
