package com.dark.rs2.content.skill.ranged;
...
import com.dark.rs2.entity.item.BasicItemContainer;
...
public class RangedSkill {
	...
	public static final boolean requiresArrow(Player player, int id) {
		if (id == 4214 || id == 10034 || id == 11959 || id == 4236 || id == 10033 || id == 12924) {
			return false;
		}
	...
	public void doActionsForChinchompa(Entity attacking) {
		Item weapon = player.getEquipment().getItems()[3];
		if (weapon != null && weapon.getId() == 10034 || weapon.getId() == 10033 || weapon.getId() == 11959) {
	...
	public void dropArrowAfterHit() {
		...
		if ((arrow.getId() == 15243) || (arrow.getId() == 4740) || (arrow.getId() == 10034) || (arrow.getId() == 11959) || (arrow.getId() == 10033)) {
			return;
		}
	...
	public void removeArrowsOnAttack() {
		...
		case SHOT:
			...
			if (ammo != null && arrow != null) {
				if (cape != null && (cape.getId() == 10499 || cape.getId() == 10498 || cape.getId() == 13337) && !ammo.getDefinition().getName().contains("dart")) {
