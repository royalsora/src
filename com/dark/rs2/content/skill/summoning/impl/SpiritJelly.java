package com.dark.rs2.content.skill.summoning.impl;

import com.dark.rs2.content.combat.Combat.CombatTypes;
import com.dark.rs2.content.skill.summoning.FamiliarMob;
import com.dark.rs2.content.skill.summoning.FamiliarSpecial;
	...
	public boolean execute(Player player, FamiliarMob mob) {
		...
		if (a != null) {
			...
			if (a.getLevels()[0] > a.getMaxLevels()[0] - 5) {
				...
				if (!a.isNpc()) {
					Player p = com.dark.rs2.entity.World.getPlayers()[a
							.getIndex()];
