...
public class Mining {
	...
	public static enum Ore {
		...
		IRON("Iron ore", new int[] { 7455, 13711 }, 15, 35, new int[] { 440 }, 10081, 12, 4),
		SILVER_ORE("Silver ore", new int[] { 7490, 13717 }, 20, 40, new int[] { 442 }, 10081, 15, 6),
		COAL_ORE("Coal ore", new int[] { 7489, 13714 }, 30, 50, new int[] { 453 }, 10081, 12, 7),
		GOLD_ORE("Gold ore", new int[] { 7491, 13715 }, 40, 65, new int[] { 444 }, 10081, 15, 7),
		
		MITHRIL_ORE("Mithril ore", new int[] { 7492, 13719 }, 55, 80, new int[] { 447 }, 10081, 15, 10),
		ADAMANT_ORE("Adamant ore", new int[] { 7493, 14168 }, 70, 95, new int[] { 449 }, 10081, 15, 18),
		RUNITE_ORE("Runite ore", new int[] { 7494 }, 85, 125, new int[] { 451 }, 10081, 15, 30),
