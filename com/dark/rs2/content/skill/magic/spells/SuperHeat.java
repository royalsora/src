...
public class SuperHeat extends Spell {
    ...
    public enum HeatData {
        ...
        MITHRIL_BAR(2359, new int[][] { { 447, 1 }, { 453, 1 } }, 50, 30),       
        ADAMANT_BAR(2361, new int[][] { { 449, 1 }, { 453, 1 } }, 70, 37.5),        
        RUNITE_BAR(2363, new int[][] { { 451, 1 }, { 453, 2 } }, 85, 50);
	...
	public boolean execute(Player player) {	
	   ...
	   player.getSkill().addExperience(Skills.MAGIC, data.getExperience());
