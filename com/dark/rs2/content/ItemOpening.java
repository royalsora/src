...
public enum ItemOpening {
	...
	/* Barrows Sets */
	DHAROK_ARMOUR_SET(12877, new Item[] { new Item(4716), new Item(4720), new Item(4722), new Item(4718), }),
	TORAG_ARMOUR_SET(12879, new Item[] { new Item(4745), new Item(4749), new Item(4751), new Item(4747), }),
	AHRIMS_ARMOUR_SET(12881, new Item[] { new Item(4708), new Item(4712), new Item(4714), new Item(4710), }),
	KARILS_ARMOUR_SET(12883, new Item[] { new Item(4732), new Item(4736), new Item(4738), new Item(4734), }),
	VERACS_ARMOUR_SET(12875, new Item[] { new Item(4753), new Item(4757), new Item(4759), new Item(4755), }),
	GUTHANS_ARMOUR_SET(12873, new Item[] { new Item(4724), new Item(4726), new Item(4728), new Item(4730) }),
	/* Achievement Armour */
	...
	/* Magic Box */
	MAGIC_BOX(13187, new Item(554, 1000), new Item(555, 1000), new Item(556, 1000), new Item(557, 1000), new Item(558, 1000), new Item(559, 1000), new Item(560, 1000), new Item(563, 1000), new Item(561, 1000), new Item(565, 1000), new Item(564, 1000), new Item(566, 1000), new Item(9075, 1000), new Item(562, 1000)),

	/* Herb Box */
	HERBLORE_BOX(11738, new Item(200, 100), new Item(202, 100), new Item(204, 100), new Item(206, 100), new Item(208, 50), new Item(210, 100), new Item(212, 75), new Item(214, 50), new Item(216, 50), new Item(218, 25), new Item(220, 25)),
	...
	public static boolean openSet(Player player, int item) {
		...
		AchievementHandler.activateAchievement(player, AchievementList.OPEN_15_ITEM_SETS, 1);
