...
public class PlayerBackupTask extends Task {
	...
	public static void backup() {
		...
		String backupFolder = System.getProperty("user.home") + File.separator + "Horizon-OS-backups" + File.separator + new SimpleDateFormat("[EE MMM d][h.mma]").format(new Date()) + File.separator + "characters" + File.separator;
		...
		for (File file : new File(System.getProperty("user.home") + File.separator + "Horizon-OS-backups").listFiles()) {
