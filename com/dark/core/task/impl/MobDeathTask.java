...
import com.dark.rs2.entity.mob.MobDrops;
import com.dark.rs2.entity.mob.Walking;
		...
		Task death = new Task(mob, 2, false, Task.StackType.STACK, Task.BreakType.NEVER, TaskIdentifier.CURRENT_ACTION) {
			...
			public void execute() {
				...
				if ((killer != null) && (!killer.isNpc())) {
					MobSounds.sendDeathSound(com.dark.rs2.entity.World.getPlayers()[killer.getIndex()], mob.getId());
				}
