...
import com.dark.GameDataLoader;
import com.dark.core.network.PipelineFactory;
import com.dark.core.task.TaskQueue;
import com.dark.core.util.LineCounter;
import com.dark.core.util.Stopwatch;
...
public class GameThread extends Thread {
	...
	private static void startup() throws Exception {
		...
		logger.info("Launching Horizon-OS..");
